...
API_URL = "https://api-inference.huggingface.co/models/meta-llama/Llama-2-7b-chat-hf" # "https://api-inference.huggingface.co/models/gpt2"
API_TOKEN = "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"
...
class FileIngestor:
    ...
    def handlefileandingest(self):
        ...
        #chain = ConversationalRetrievalChain.from_api(API_URL, API_TOKEN)
